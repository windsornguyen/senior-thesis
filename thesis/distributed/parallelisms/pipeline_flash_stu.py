...
from thesis.models.flash_stu import FlashSTUConfig
...
def pipeline_flash_stu(
    ...
    """
    Applies pipeline parallelism to the Flash STU model.
    """
    stages, models = pipeline_flash_stu_manual_split(
        whole_model=model,
        pp_mesh=pp_mesh,
...
def pipeline_flash_stu_manual_split(
