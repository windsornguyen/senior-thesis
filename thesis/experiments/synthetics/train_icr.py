    ...
    while step < max_steps:
        ...
        for inputs, targets in loader:
            ...
            if step % eval_interval == 0:
                ...
                recall_acc = compute_recall_accuracy(model, val_loader, attn_mask=attn_mask)
...
if __name__ == "__main__":
    ...
    loss_history_trans, overall_accuracy_history_trans, recall_accuracy_history_trans, eval_steps_trans = train_model(
        trans_recall_model, loader, val_loader, max_steps=10000, eval_interval=250
    )
    ...
    loss_history_spectron, overall_accuracy_history_spectron, recall_accuracy_history_spectron, eval_steps_spectron = (
        train_model(spectron, loader, val_loader, max_steps=10000, eval_interval=250)
    )
    ...
    print("\n--- Example Predictions ---")
    show_example_predictions(trans_recall_model, "Transformer", train_dataset)
