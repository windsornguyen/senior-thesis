...
# Dataset configs
parser.add_argument("--num_examples", type=int, default=12800, help="Number of training examples")
...
parser.add_argument("--bsz", type=int, default=128, help="Batch size for training")
...
parser.add_argument("--num_eigh", type=int, default=24, help="Number of eigenvectors")
...
parser.add_argument("--torch_compile", type=bool, default=True, help="Use torch.compile")
